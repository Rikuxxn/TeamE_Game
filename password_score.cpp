...
void InitPassword(void)
{
	...
	for (nCntPassword = 0; nCntPassword < MAX_NUM_SCORE; nCntPassword++)
	{
		...
		pVtx2[1].tex = D3DXVECTOR2(0.1f, 0.0f);
		pVtx2[2].tex = D3DXVECTOR2(0.0f, 1.0f);
		pVtx2[3].tex = D3DXVECTOR2(0.1f, 1.0f);
		pVtx2 += 4;
	}
	// 頂点バッファをアンロックする
	...
	for (nCntPassword = 0; nCntPassword < MAX_NUM_SCORE; nCntPassword++)
	{
		...
		pVtx3[1].tex = D3DXVECTOR2(0.1f, 0.0f);
		pVtx3[2].tex = D3DXVECTOR2(0.0f, 1.0f);
		pVtx3[3].tex = D3DXVECTOR2(0.1f, 1.0f);
		pVtx3 += 4;
	}
	// 頂点バッファをアンロックする
...
void SetPassword(int nPass, int nA, bool bAnswer)
{
	...
	for (nCntPassword = 0; nCntPassword < MAX_NUM_SCORE; nCntPassword++)
	{
		...
		pVtx[1].tex = D3DXVECTOR2(0.1f + (0.1f * aPosTexU[nCntPassword]), 0.0f);
		pVtx[2].tex = D3DXVECTOR2(0.0f + (0.1f * aPosTexU[nCntPassword]), 1.0f);
		pVtx[3].tex = D3DXVECTOR2(0.1f + (0.1f * aPosTexU[nCntPassword]), 1.0f);
		pVtx += 4;
	}
	// 頂点バッファをアンロックする
	g_pVtxBuffPassword->Unlock();
	...
	for (nCntPassword = 0; nCntPassword < MAX_NUM_SCORE; nCntPassword++)
	{
		...
		pVtx[1].tex = D3DXVECTOR2(0.1f + (0.1f * aPosTexU2[nCntPassword]), 0.0f);
		pVtx[2].tex = D3DXVECTOR2(0.0f + (0.1f * aPosTexU2[nCntPassword]), 1.0f);
		pVtx[3].tex = D3DXVECTOR2(0.1f + (0.1f * aPosTexU2[nCntPassword]), 1.0f);
		pVtx += 4;
	}
	// 頂点バッファをアンロックする
	g_pVtxBuffPassword2->Unlock();
	...
	for (nCntPassword = 0; nCntPassword < MAX_NUM_SCORE; nCntPassword++)
	{
		...
		pVtx[1].tex = D3DXVECTOR2(0.1f + (0.1f * aPosTexU3[nCntPassword]), 0.0f);
		pVtx[2].tex = D3DXVECTOR2(0.0f + (0.1f * aPosTexU3[nCntPassword]), 1.0f);
		pVtx[3].tex = D3DXVECTOR2(0.1f + (0.1f * aPosTexU3[nCntPassword]), 1.0f);
		pVtx += 4;
	}
	// 頂点バッファをアンロックする
	g_pVtxBuffPassword3->Unlock();
	...
	for (nCntPassword = 0; nCntPassword < MAX_NUM_SCORE; nCntPassword++)
	{
		...
		pVtx[1].tex = D3DXVECTOR2(0.1f + (0.1f * aPosTexU4[nCntPassword]), 0.0f);
		pVtx[2].tex = D3DXVECTOR2(0.0f + (0.1f * aPosTexU4[nCntPassword]), 1.0f);
		pVtx[3].tex = D3DXVECTOR2(0.1f + (0.1f * aPosTexU4[nCntPassword]), 1.0f);
		pVtx += 4;
	}
	// 頂点バッファをアンロックする
	g_pVtxBuffPassword4->Unlock();
