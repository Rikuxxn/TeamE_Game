...
void InitCraneBackGround(void)
{
	...
	D3DXCreateTextureFromFile(pDevice,
		"data\\TEXTURE\\Crane_bg2.png",//テクスチャのファイル名
		&g_pTextureCraneBG[0]);

	//テクスチャ1の読み込み
	D3DXCreateTextureFromFile(pDevice,
		"data\\TEXTURE\\Mini_Crane_Tutorial.png",//テクスチャのファイル名
		&g_pTextureCraneBG3);
	...
	{
		//頂点座標の設定
		pVtx[0].pos = D3DXVECTOR3(FIELD_LEFT, FIELD_TOP, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(FIELD_RIGHT, FIELD_TOP, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(FIELD_LEFT, FIELD_UNDER, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(FIELD_RIGHT, FIELD_UNDER, 0.0f);
