...
void InitBallBackGround(void)
{
	...
	D3DXCreateTextureFromFile(pDevice,
		...
		&g_pTextureBallBG[0]);
	D3DXCreateTextureFromFile(pDevice,
		"data\\TEXTURE\\Mini_Ball_Tutorial.png",
		&g_pTextureBallBG3);
	...
	for (nCntBG = 0; nCntBG < NUM_BG;nCntBG++)
	{
		...
		pVtx[1].tex = D3DXVECTOR2(g_aBallPosTexU[nCntBG] + 1.0f, 0.0f);
		pVtx[2].tex = D3DXVECTOR2(g_aBallPosTexU[nCntBG], 1.0f);
		pVtx[3].tex = D3DXVECTOR2(g_aBallPosTexU[nCntBG] + 1.0f, 1.0f);
